...
//cette classe permet d'enregistrer l'ensemble des notifications dans une liste
public class BLE_ListStored {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public BLE_ListStored(Context appContext) {
    ...
    public ArrayList<String> getListObject(String key) {
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            String value = gson.fromJson(jObjString, String.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<String> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
